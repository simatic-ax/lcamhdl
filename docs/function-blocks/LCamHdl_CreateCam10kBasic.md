...
The function block `CreateCam10kBasic` is a copy of the function block
[CreateCamBasic](./LCamHdl_CreateCamBasic.md). The "..10k.." version enables using a cam technology object of type `TO_Cam_10k` instead of `TO_Cam`.
