# CreateCam10kBasedOnXYPoints

## Description

The function block `CreateCam10kBasedOnXYPoints` is a copy of the
function block [CreateCamBasedOnXYPoints](./LCamHdl_CreateCamBasedOnXYPoints.md). The "..10k.." version
