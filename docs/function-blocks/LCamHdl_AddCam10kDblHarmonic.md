# LCamHdl_AddCam10kDblHarmonic

The function block `LCamHdl_AddCam10kDblHarmonic` is a copy of the function
block [LCamHdl_AddCamDblHarmonic](./LCamHdl_AddCamDblHarmonic.md). The "..10k.." version enables using a cam technology object of type `TO_Cam_10k` instead of `TO_Cam`, i.e. the maximum number of interpolation points increases from 1000 to 10000.
