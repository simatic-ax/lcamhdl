# AddCam10kDblHarmonic

The function block `AddCam10kDblHarmonic` is a copy of the function
block [AddCamDblHarmonic](./LCamHdl_AddCamDblHarmonic.md). The "..10k.." version enables using a cam technology object of type `TO_Cam_10k` instead of `TO_Cam`, i.e. the maximum number of interpolation points increases from 1000 to 10000.
...
| `config` | [`typeDblHarmonicConfig`](../types/LCamHdl_typeDblHarmonicConfig.md) | - | Config for interpolating the cam disk and deleting preceding or successive cam points/segments |
...
| Parameter | Type | Description |
| --------- | ---- | ----------- |
| `camProfile` | `ARRAY[*] OF` [`typeDblHarmonicElement`](../types/LCamHdl_typeDblHarmonicElement.md) | Definition of the cam disk to be created |
