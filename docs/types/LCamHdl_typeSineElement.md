...
| `camProfileType` | `DINT` | `51` | Profile type of the cam disk element, 51: `ADD_PROFILE_SINE` (default) |
| `sineMode` | `DINT` | `0` | Profile mode, 0: `SINE_MODE_PHASE_START_AND_END` (default) |
| `inclinationMode` | `DINT` | `0` | Inclination mode, 0: `SINE_INCL_MODE_DISPLACEMENT_START_AND_END` (default) |
